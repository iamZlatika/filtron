...
export type LoginAttempt =
  $Result.DefaultSelection<Prisma.$LoginAttemptPayload>;
...
export namespace Prisma {
  ...
  */
  ...
  > = {
    ...
    meta: {
      modelProps: "news" | "user" | "loginAttempt";
      ...
      LoginAttempt: {
        ...
        operations: {
          ...
          count: {
            ...
            result:
              | $Utils.Optional<LoginAttemptCountAggregateOutputType>
              | number;
          };
        };
      };
  ...
  type NewsGetPayload<S extends boolean | null | undefined | NewsDefaultArgs> =
    $Result.GetResult<Prisma.$NewsPayload, S>;
  ...
  > {
    ...
    updateManyAndReturn<T extends NewsUpdateManyAndReturnArgs>(
      args: SelectSubset<T, NewsUpdateManyAndReturnArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<
      $Result.GetResult<
        Prisma.$NewsPayload<ExtArgs>,
        T,
    ...
    aggregate<T extends NewsAggregateArgs>(
      args: Subset<T, NewsAggregateArgs>,
    ...
    >(
      args: SubsetIntersection<T, NewsGroupByArgs, OrderByArg> & InputErrors,
    ): {} extends InputErrors
  ...
  > = {
     ...
     */
    orderBy?:
      | LoginAttemptOrderByWithRelationInput
      | LoginAttemptOrderByWithRelationInput[];
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     *
  ...
  export type GetLoginAttemptAggregateType<
    T extends LoginAttemptAggregateArgs,
  > = {
  ...
  > = {
    where?: LoginAttemptWhereInput;
    orderBy?:
      | LoginAttemptOrderByWithAggregationInput
      | LoginAttemptOrderByWithAggregationInput[];
  ...
  type GetLoginAttemptGroupByPayload<T extends LoginAttemptGroupByArgs> =
    Prisma.PrismaPromise<
      Array<
        PickEnumerable<LoginAttemptGroupByOutputType, T["by"]> & {
          [P in keyof T &
            keyof LoginAttemptGroupByOutputType]: P extends "_count"
            ? T[P] extends boolean
              ? number
  ...
  export type LoginAttemptSelectCreateManyAndReturn<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = $Extensions.GetSelect<
    {
      id?: boolean;
  ...
  export type LoginAttemptSelectUpdateManyAndReturn<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = $Extensions.GetSelect<
    {
      id?: boolean;
  ...
  export type LoginAttemptOmit<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = $Extensions.GetOmit<
    "id" | "ip" | "count" | "lastAttempt",
    ExtArgs["result"]["loginAttempt"]
  >;
  ...
  type LoginAttemptGetPayload<
    S extends boolean | null | undefined | LoginAttemptDefaultArgs,
  > = $Result.GetResult<Prisma.$LoginAttemptPayload, S>;

  type LoginAttemptCountArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = Omit<
    LoginAttemptFindManyArgs,
    "select" | "include" | "distinct" | "omit"
  > & {
    select?: LoginAttemptCountAggregateInputType | true;
  };

  export interface LoginAttemptDelegate<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
    GlobalOmitOptions = {},
  > {
    [K: symbol]: {
      types: Prisma.TypeMap<ExtArgs>["model"]["LoginAttempt"];
      meta: { name: "LoginAttempt" };
    };
    /**
     ...
     * })
     */
    findUnique<T extends LoginAttemptFindUniqueArgs>(
      args: SelectSubset<T, LoginAttemptFindUniqueArgs<ExtArgs>>,
    ): Prisma__LoginAttemptClient<
      $Result.GetResult<
     ...
     * })
     */
    findFirst<T extends LoginAttemptFindFirstArgs>(
     ...
     *
     */
    createManyAndReturn<T extends LoginAttemptCreateManyAndReturnArgs>(
     ...
     *
     */
    updateManyAndReturn<T extends LoginAttemptUpdateManyAndReturnArgs>(
      args: SelectSubset<T, LoginAttemptUpdateManyAndReturnArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<
      $Result.GetResult<
        Prisma.$LoginAttemptPayload<ExtArgs>,
        T,
     ...
     * })
     **/
    aggregate<T extends LoginAttemptAggregateArgs>(
      args: Subset<T, LoginAttemptAggregateArgs>,
    ): Prisma.PrismaPromise<GetLoginAttemptAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, LoginAttemptGroupByArgs, OrderByArg> &
        InputErrors,
    ): {} extends InputErrors
      ? GetLoginAttemptGroupByPayload<T>
      : Prisma.PrismaPromise<InputErrors>;
    /**
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export interface Prisma__LoginAttemptClient<
    T,
    Null = never,
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
    GlobalOmitOptions = {},
   ...
   */
  export type LoginAttemptFindUniqueOrThrowArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the LoginAttempt
   ...
   */
  export type LoginAttemptFindFirstOrThrowArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the LoginAttempt
   ...
   */
  export type LoginAttemptCreateManyAndReturnArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the LoginAttempt
  ...
  > = {
     ...
     */
    data: XOR<
      LoginAttemptUpdateManyMutationInput,
      LoginAttemptUncheckedUpdateManyInput
    >;
    /**
   ...
   */
  export type LoginAttemptUpdateManyAndReturnArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the LoginAttempt
   ...
   */
  export type LoginAttemptDefaultArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the LoginAttempt
  ...
  export type LoginAttemptScalarWhereWithAggregatesInput = {
    AND?:
      | LoginAttemptScalarWhereWithAggregatesInput
      | LoginAttemptScalarWhereWithAggregatesInput[];
